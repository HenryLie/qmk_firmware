...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|+------------+------------+------------+------------+-------------|                             |-------------+------------+------------+------------+------------|
           KC_BTN4,     KC_BTN3,     KC_BTN2,     KC_BTN1,      KC_VOLU,                                    KC_BRIU,     KC_MS_L,     KC_MS_U,     KC_MS_D,     KC_MS_R,
  //|+------------+------------+------------+------------+-------------|                             |-------------+------------+------------+------------+------------|
           XXXXXXX,     DT_DOWN,       DT_UP,     DT_PRNT,      KC_VOLD,                                    KC_BRID,     KC_WH_L,     KC_WH_U,     KC_WH_D,     KC_WH_R,
  //|+------------+------------+------------+------------+--------------+------------|  |------------+-------------+------------+------------+------------+------------|
