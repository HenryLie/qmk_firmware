...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
  //|--------------------------------------------------------------------------------------------|                 |-----------------------------------------------------------------------------------------------|
       KC__VOLUP,           KC_Q,           KC_W,           KC_F,           KC_P,           KC_G,                              KC_J,            KC_L,            KC_U,            KC_Y,         KC_SCLN,   KC_MFFD,
  //|------------+---------------+---------------+---------------+---------------+---------------|                 |----------------+----------------+----------------+----------------+----------------+----------|
        KC__MUTE,    SFT_T(KC_A),    CTL_T(KC_R),    ALT_T(KC_S),    GUI_T(KC_T),           KC_D,                              KC_H,     GUI_T(KC_N),     ALT_T(KC_E),     CTL_T(KC_I),     SFT_T(KC_O),   KC_MPLY,
  //|------------+---------------+---------------+---------------+---------------+---------------|                 |----------------+----------------+----------------+----------------+----------------+----------|
     KC__VOLDOWN,           KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,                              KC_K,            KC_M,         KC_COMM,          KC_DOT,         KC_QUOT,   KC_MRWD,
  //|------------+---------------+---------------+---------------+---------------+---------------+--------+--------+----------------+----------------+----------------+----------------+----------------+----------|
                           XXXXX,          XXXXX, CTL_T(KC_QUOT), GUI_T(KC_BSPC),      LOWER_ESC, KC_BRMU, KC_BRMD,       LOWER_ENT,   SFT_T(KC_SPC),  ALGR_T(KC_GRV),         KC_MPRV,         KC_MNXT
              //|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
  ),
  ...
  //|--------+---------------+---------------+---------------+---------------+---------------|                 |----------------+----------------+----------------+----------------+----------------+----------|
       XXXXX, SFT_T(KC_DQUO), CTL_T(KC_QUOT),  ALT_T(KC_GRV),  GUI_T(KC_TAB),        KC_MINS,                            KC_EQL,         KC_LEFT,           KC_UP,         KC_DOWN,        KC_RIGHT,     XXXXX,
  //|--------+---------------+---------------+---------------+---------------+---------------|                 |----------------+----------------+----------------+----------------+----------------+----------|
       XXXXX,        KC_LBRC,          KC_LT,        KC_LCBR,        KC_LPRN,        KC_BSLS,                           KC_SLSH,         KC_RPRN,         KC_RCBR,           KC_GT,         KC_RBRC,     XXXXX,
  //|--------+---------------+---------------+---------------+---------------+---------------+--------+--------+----------------+----------------+----------------+----------------+----------------+----------|
                       XXXXX,          XXXXX, CTL_T(KC_QUOT), GUI_T(KC_BSPC),          _____,   XXXXX,   XXXXX,           _____,   SFT_T(KC_SPC),  ALGR_T(KC_GRV),           XXXXX,           XXXXX
          //|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
  ),
...
// const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
// 	[0] = LAYOUT(KC_NO, KC_Q, KC_W, KC_F, KC_P, KC_G, KC_J, KC_L, KC_U, KC_Y, KC_SCLN, KC_NO, KC_NO, KC_A, KC_R, KC_S, KC_T, KC_D, KC_H, KC_N, KC_E, KC_I, KC_O, KC_NO, KC_NO, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_K, KC_M, KC_COMM, KC_DOT, KC_QUOT, KC_NO, KC_NO, KC_NO, KC_LCPO, LCTL_T(KC_SPC), LT(2,KC_ENT), KC_NO, KC_NO, LT(1,KC_ESC), LSFT_T(ALGR_T(KC_KANA), KC_NO, KC_NO),
